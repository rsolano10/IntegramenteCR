...
export function Ficha() {
  ...
  const setMensajeFamilia = useAppStore((s) => s.setMensajeFamilia);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-6 items-start">
        ...
        <div className="grid gap-4">
          ...
          <div className="bg-white border border-borde rounded-2xl p-6">
            ...
            />
            <Button dense variant="ink" className="mt-3" onClick={sendMensajeFamilia}>
              {mensajeFamiliaEnviado ? "Enviado ✓ — enviar de nuevo" : "Enviar a la familia"}
            </Button>
            {mensajeFamiliaEnviado && (
              <p className="m-0 mt-2 text-sm text-verde-profundo">Marcela ya puede verlo en su vista de Hoy.</p>
            )}
          </div>
